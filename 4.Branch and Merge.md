...
![Branch選擇](./Github_Branch_select.png)

branch_name這個選擇，點入後你就會看到我稍早新增的，點入後可以發現確實多了test_branch_name.md


![Branch_name截圖](./Github_Branch_name.png)
...
![Branch_name_Contribute](./Branch_name_Contribute.png)


按下來後你會看到

![pull request_1](./Pull%20request_1.png)
...
![pull request_2](./Pull%20request_2.png)
...
![pull request_check](./Pull_request_check.png)
...
![merge_options](./Merge_options.png)
...
![merge_successful](./Merge_successful.png)

這邊就有顯示Merged合併了，並且關閉了這個請求，這時你回到Repo首頁，你會看到branch_name跟main已經合併了

### 合併前
![Github_Before_merge](./Github_Before_merge.png)


### 合併後
![Github_After_merge](./Github_After_merge.png)
